...
export default function Hero() {
    return (
        <section id="hero" className="relative min-h-[100svh] lg:min-h-[112svh] flex items-center justify-center overflow-hidden gradient-hero pt-20 lg:pt-24">
            ...
            <div className="relative z-10 w-full max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center justify-between gap-10 lg:gap-16 xl:gap-24">

                {/* Left Copy */}
                <motion.div
                    className="flex-1 text-center lg:text-left text-white max-w-2xl lg:max-w-[640px] mx-auto lg:mx-0 pt-8 sm:pt-12 lg:pt-0"
                ...
                >
                    ...
                    <motion.h1 variants={itemVariants} className="text-[34px] sm:text-[40px] md:text-[56px] lg:text-[76px] xl:text-[88px] font-extrabold leading-[1.02] tracking-tight mb-6 text-balance">
                    ...
                    {/* Subtitle */}
                    <motion.p variants={itemVariants} className="text-base sm:text-lg md:text-xl text-white/80 font-normal leading-relaxed mb-8 sm:mb-10 max-w-xl mx-auto lg:mx-0">
                    ...
                    {/* Buttons */}
                    <motion.div variants={itemVariants} className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-3 sm:gap-4 mb-10 sm:mb-12 w-full">
                        <a
                            href={CHROME_WEB_STORE_URL}
                            target="_blank"
                            rel="noreferrer"
                            className="w-full sm:w-auto px-6 sm:px-8 py-4 rounded-xl gradient-cta text-white font-bold text-base sm:text-lg shadow-cta hover:shadow-cta-hover transition-all hover:-translate-y-0.5"
                        >
                            Installer sur Chrome — C'est gratuit
                        </a>
                        <a
                            href="#showcase"
                            className="w-full sm:w-auto px-6 sm:px-8 py-4 rounded-xl bg-transparent border border-white/30 text-white font-bold text-base sm:text-lg hover:bg-white/10 transition-colors"
                        >
                            Voir la démo ↓
                        </a>
                    </motion.div>
                    ...
                    {/* Badges */}
                    <motion.div variants={{ hidden: { opacity: 0 }, visible: { opacity: 1, transition: { delay: 1, duration: 1 } } }} className="flex flex-wrap justify-center lg:justify-start gap-3 text-xs sm:text-sm font-medium">
                        <a href="https://www.leboncoin.fr" target="_blank" rel="noreferrer" className="px-3 sm:px-4 py-2 rounded-full bg-white/5 border border-white/10 text-white/90 backdrop-blur-sm flex items-center gap-2 hover:bg-white/15 hover:border-white/30 transition-all cursor-pointer">
                        ...
                        <a href="https://www.lacentrale.fr" target="_blank" rel="noreferrer" className="px-3 sm:px-4 py-2 rounded-full bg-white/5 border border-white/10 text-white/90 backdrop-blur-sm flex items-center gap-2 hover:bg-white/15 hover:border-white/30 transition-all cursor-pointer">
                        ...
                        <a href="https://www.autoscout24.ch" target="_blank" rel="noreferrer" className="px-3 sm:px-4 py-2 rounded-full bg-white/5 border border-white/10 text-white/90 backdrop-blur-sm flex items-center gap-2 hover:bg-white/15 hover:border-white/30 transition-all cursor-pointer">
                ...
                {/* Right Visual (Mockup) */}
                <motion.div
                    className="flex-1 w-full max-w-[560px] lg:max-w-[760px] xl:max-w-[820px] relative mt-4 sm:mt-8 lg:mt-0"
                ...
                >
                    ...
                    <div className="relative rounded-[28px] bg-white shadow-popup overflow-hidden border border-black/5 flex flex-col h-[440px] sm:h-[560px] md:h-[620px] lg:h-[680px] xl:h-[720px] max-h-[82vh] lg:max-h-none">
                        {/* Fake browser header */}
                    ...
                    <motion.div
                        className="absolute right-2 sm:right-4 md:right-5 lg:-right-14 xl:-right-20 2xl:-right-24 top-4 sm:top-8 md:top-10 lg:top-[26%] bg-white rounded-2xl shadow-glass p-3 sm:p-4 border border-gray-100 flex items-center gap-3 z-20 max-w-[190px] sm:max-w-[210px] xl:max-w-[220px]"
